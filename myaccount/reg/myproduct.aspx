...
<script runat="server">
    ...
    Sub BindGrid()
        ...
        If SortField = String.Empty Then
            CommandText = "SELECT [Products].[ProductID], [Products].[Title], "& _
    "[Products].[MakeAvailable] FROM [Products] order by [Products].[ProductID] desc"
        Else
            CommandText = "SELECT [Products].[ProductID], [Products].[Title], "& _
    "[Products].[MakeAvailable] FROM [Products] order by " & SortField
        End If
                ...
                <td bordercolor="#e0e0e0" colspan="6" height="100%" style="border-left-color: #e0e0e0; border-bottom-color: #e0e0e0; border-top-style: solid; border-top-color: #e0e0e0; border-right-style: solid; border-left-style: solid; border-right-color: #e0e0e0; border-bottom-style: solid">
                    ...
                    <form id="Form1" runat="server">
                        ...
                        <p align="left">
                            &nbsp;</p>
                        <p align="left">
                            &nbsp;<img src="../../images/pointer.gif" border="0" />&nbsp;<a href="../../myaccount/reg/addproduct.aspx"><strong>Add
                            ...
                            <asp:datagrid id="DataGrid1" runat="server" width="100%" OnPageIndexChanged="DataGrid_Page" OnSortCommand="DataGrid_Sort" BorderColor="#ffffff" BorderWidth="1px" BorderStyle="None" CellPadding="3" BackColor="White" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="Title" SortExpression="Title" ReadOnly="True" HeaderText="Title"></asp:BoundColumn>
                                    <asp:HyperLinkColumn Text="Edit/Delete" DataNavigateUrlField="ProductID" DataNavigateUrlFormatString="modifyproduct.aspx?productid={0}"></asp:HyperLinkColumn>
                                    <asp:HyperLinkColumn DataNavigateUrlField="ProductID" DataNavigateUrlFormatString="productdetails.aspx?productid={0}"
                                        Text="Quantity/Price"></asp:HyperLinkColumn>
                                </Columns>
                            </asp:datagrid>
                        </p>
                            <p>
                                &nbsp;<img src="../../images/pointer.gif" border="0" />&nbsp;<a href="../../myaccount/reg/addcolour.aspx"><strong>Add
                            New Colour</strong></a></p>
                    </form>
                </td>
            </tr>
            <tr>
